...
[![ndc-hub](https://img.shields.io/badge/ndc--hub-postgres-blue.svg?style=flat)](https://hasura.io/connectors/postgres-promptql)
[![License](https://img.shields.io/badge/license-Apache--2.0-purple.svg?style=flat)](LICENSE.txt)
[![Status](https://img.shields.io/badge/status-alpha-yellow.svg?style=flat)](./readme.md)

With this connector, Hasura allows you to instantly create a real-time GraphQL API on top of your data models in
Postgres. This connector supports Postgres's functionalities listed in the table below, allowing for efficient and
...
- [Connector information in the Hasura Hub](https://hasura.io/connectors/postgres-promptql)
...
The official Postgres JDBC driver is used. You can find documentation on configuring the JDBC connection string
[here](https://jdbc.postgresql.org/documentation/). As an example:
```
...
The Hasura Postgres connector is available under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
