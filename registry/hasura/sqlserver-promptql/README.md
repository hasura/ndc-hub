...
[![ndc-hub](https://img.shields.io/badge/ndc--hub-sqlserver-blue.svg?style=flat)](https://hasura.io/connectors/sqlserver-promptql)
[![License](https://img.shields.io/badge/license-Apache--2.0-purple.svg?style=flat)](LICENSE.txt)
[![Status](https://img.shields.io/badge/status-alpha-yellow.svg?style=flat)](./readme.md)

With this connector, Hasura allows you to instantly create a real-time GraphQL API on top of your data models in
SQL Server. This connector supports SQL Server's functionalities listed in the table below, allowing for efficient and
...
- [Connector information in the Hasura Hub](https://hasura.io/connectors/sqlserver-promptql)
...
The official SQL Server JDBC driver is used. You can find documentation on configuring the JDBC connection string
[here](https://learn.microsoft.com/en-us/sql/connect/jdbc/building-the-connection-url?view=sql-server-ver17). As an example:
```
APP_FOO_JDBC_URL=promptql:sqlserver://localhost:3306/Chinook?user=root&password=mypassword
```
