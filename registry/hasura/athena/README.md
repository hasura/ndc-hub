...
Amazon Athena DB. This connector supports Athena's functionalities listed in the table below, allowing for efficient and
...
- [Connector information in the Hasura Hub](https://hasura.io/connectors/athena)
- [Hasura V3 Documentation](https://hasura.io/docs/3.0)

## Features

Below, you'll find a matrix of all supported features for the Athena connector:
...
The Athena DB supports various methods of authentication as documented [here](https://docs.aws.amazon.com/athena/latest/ug/jdbc-v3-driver-authentication-connection-parameters.html)


## License

The Hasura Athena connector is available under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
