...
The official Trino JDBC driver is used. You can find documentation on configuring the JDBC connection string
...
The Hasura Trino connector is available under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
