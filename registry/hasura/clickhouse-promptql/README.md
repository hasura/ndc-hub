...
[![ndc-hub](https://img.shields.io/badge/ndc--hub-clickhouse-blue.svg?style=flat)](https://hasura.io/connectors/clickhouse-jdbc)
[![License](https://img.shields.io/badge/license-Apache--2.0-purple.svg?style=flat)](LICENSE.txt)
[![Status](https://img.shields.io/badge/status-alpha-yellow.svg?style=flat)](./readme.md)

With this connector, Hasura allows you to instantly create a real-time GraphQL API on top of your data models in
Clickhouse. This connector supports Clickhouse's functionalities listed in the table below, allowing for efficient and
...
- [Connector information in the Hasura Hub](https://hasura.io/connectors/clickhouse-jdbc)
- [Hasura V3 Documentation](https://hasura.io/docs/3.0)

## Features

Below, you'll find a matrix of all supported features for the Clickhouse connector:
...
The Hasura Clickhouse connector is available under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
